...
function FileUpload({fileName, handleUpload, handleUploadChange, imageUrl }) {
  ...
  return (
    ...
    <div className="flex items-center gap-2 mb-4">
      ...
      <input id="file-upload" type="file" accept="image/*" className="hidden flex-1" onChange={handleUploadChange}></input>
