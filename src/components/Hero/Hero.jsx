  ...
  return (
    <section className="bg-gray-100 flex mx-auto max-w-screen-xl min-h-[70vh]">
        <div className="flex flex-col gap-4 justify-center items-center bg-cover w-full overflow-hidden relative" style={{ backgroundImage: `url(${Students})`}}>
            ...
            <h1 className="z-2 text-4xl text-white font-semibold">Connect with like-minded peers</h1>
            <p className="z-2 text-lg text-white">Find your dev crew. Collaborate, learn and grow together.</p>
            <Link to="signup" className="z-2 rounded bg-teal-500 px-3 py-2 mt-10 w-50 text-lg font-semibold text-white hover:bg-teal-400 text-center cursor-pointer">Join DEV@Deakin</Link>
        </div>
    </section>
  )
}
