  ...
  return (
    <section className="flex flex-col max-w-screen-xl min-h-[100dvh] w-fit mx-auto gap-4 mt-8">
        ...
        <div className="flex gap-4">
            ...
            {/* Pro Plan */}
            <article>
                <Card className="gap-4 bg-radial-[at_25%_25%] from-white to-amber-300 to-75%">
                    ...
                    <button className="cursor-pointer mt-4 rounded bg-white px-3 py-2 text-m text-zinc-700 font-medium">Subscribe</button>
                </Card>
            </article>
        </div>
    </section>
