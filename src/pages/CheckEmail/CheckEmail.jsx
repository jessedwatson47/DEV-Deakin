...
function CheckEmail() {
  return (
    <section className="flex flex-col mx-auto min-h-[100dvh] w-full items-center justify-center bg-zinc-100">
        <article className="flex flex-col items-center gap-2 bg-white p-4 rounded shadow">
